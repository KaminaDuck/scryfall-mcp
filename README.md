...
This project provides Python scripts to download card data and images from Scryfall with database-backed efficiency, as well as an MCP server for integrating with AI assistants.
